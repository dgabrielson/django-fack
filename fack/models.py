...
class Topic(models.Model):
    ...
    created_by = models.ForeignKey(User, on_delete=models.SET_NULL, verbose_name=_('created by'), null=True, blank=True, related_name="+")
    updated_by = models.ForeignKey(User, on_delete=models.SET_NULL, verbose_name=_('updated by'), null=True, blank=True, related_name="+")
...
class Question(models.Model):
    ...
    updated_by = models.ForeignKey(User, on_delete=models.SET_NULL, verbose_name=_('updated by'),
        null=True, blank=True, related_name="+")
    nr_views = models.IntegerField(default=0)
